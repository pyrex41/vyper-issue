...
provider_http = Web3.HTTPProvider("http://127.0.0.1:7545")
# web3.py instance
...
tester.languages['vyper'] = compiler
...
source_code = open('issue.vy').read()
...
byte_code = tester.languages['vyper'].compile_code(source_code)['bytecode'] + \
